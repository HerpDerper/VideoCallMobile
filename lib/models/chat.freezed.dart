...
abstract class $ChatCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? lastMessageTime, String? meetingID});
}
...
class _$_Chat implements _Chat {
  _$_Chat({this.id, this.lastMessageTime, this.meetingID});
  ...
  @override
  String toString() {
    return 'Chat(id: $id, lastMessageTime: $lastMessageTime, meetingID: $meetingID)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, lastMessageTime, meetingID);
...
abstract class _Chat implements Chat {
  factory _Chat(
      {final int? id,
      final String? lastMessageTime,
      final String? meetingID}) = _$_Chat;
